...
using System.Text;
    ...
    public class Security
    {
        ...
        public string GenerateEmailBody(string username, string requestSubmitTime, string requestFrom, string pwdResetURL)
        {
            ...
            emailBody.Append("\">Please click here to reset your MasterKey: HRM, user account password.</a></td></tr>");
        ...
        public void GetUserAuthentication(string UserName, string Password, int CompanyId)
        {
            ...
            try
            {
                ...
                _usertypeId = objMKS_Security.UserTypeId;
        ...
        public bool IsUserBlock(string UserId)
        {
            ...
            try
            {
            // isBlock= Convert.ToBoolean(  objMKS_Security.IsUserBlock(UserId));
                SetValues();
            }
            catch (Exception ex)
            {
        ...
        public void ChangeUserPassword(string UserId, string OldPassword, string NewPassword, string LoginUser)
        {
            try
            {
                objMKS_Security.ChangeUserPassword(UserId, OldPassword, NewPassword, LoginUser);
                SetValues();
            }           
            catch (Exception ex)
            {
