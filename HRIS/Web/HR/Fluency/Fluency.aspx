<%@ Page Title="HR | Fluency" Language="C#" MasterPageFile="~/HR/HR_MenuMasterPage.master"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table class="style1">
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label4" runat="server" SkinID="FormHeader" Text=" Fluency"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td style="text-align: right">
                        <asp:UpdateProgress ID="UpdateProgress2" runat="server">
                            <ProgressTemplate>
                                <img alt="" src="../../App_Themes/CommonResources/progress.gif" style="width: 25px;
                                    height: 25px" />
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                    </td>
