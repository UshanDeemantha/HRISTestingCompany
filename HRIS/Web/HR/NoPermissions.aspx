<%@ Page Title="HRM Common | User Permission Denied" Language="C#" MasterPageFile="~/HR/HR_MenuMasterPage.master" AutoEventWireup="true" CodeFile="NoPermissions.aspx.cs" Inherits="NoPermissions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:Label runat="server"  Font-Size="16px"
