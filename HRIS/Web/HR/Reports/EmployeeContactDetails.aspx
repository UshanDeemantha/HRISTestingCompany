<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeContactDetails.aspx.cs" Inherits="HR_Reports_EmployeeContactDetails" MasterPageFile="~/HR/HR_MenuMasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="row">
            <div class="col head-container">
                <h4 class="header">Employee Contact Details Reports</h4>
        ...
        <div class="col-md-12" style="border-top-color: black">
            <div class="border" style="border-radius: 10px">
                <div class="card-body shadow" style="border-top-color: #097cbd; border-top-width: 5px; background-color: white; border-radius: 10px">
                    ...
                    <Items>
                        <dx:ListEditItem Text="Employee Contact Details" Value="7" />
                        <dx:ListEditItem Text="Employee Emergency Contact Details" Value="8" />
                                </Items>
                            </dx:ASPxComboBox>
                        </div>
                         <div class="col-md-6">
