<%@ Page Title="HRIS Employee | Employee Bulk Additional Details Upload" Language="C#" AutoEventWireup="true" CodeFile="EmployeeAdditionalDataUpload.aspx.cs" Inherits="HR_Employee_EmployeeAdditionalDataUpload" MasterPageFile="~/HR/HR_MenuMasterPage.master"%>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <div class="row">
            <div class="col head-container">
                <h4 class="header">Bulk Employee Additional Upload</h4>
        ...
        <div style="display: grid; grid-gap: 10px; grid-template-columns: 1fr 1fr; place-content: center; margin-top: 35px;">
            ...
            <ul class="infoInnerMargin">
                ...
                <li><b style="color:#0c65a5">*</b> Excel file <b style="color:#0c65a5">Sheet Name</b> containing employee master data should be named as <b style="color:#0c65a5">'EmployeeAdditionalDetails'</b>.</li>
