...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table>
            <tr>
                <td class="style2">&nbsp;</td>
                <td class="style5">Search Employee</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="style2">&nbsp;</td>
            ...
            <tr>
                <td class="style2">&nbsp;</td>
                <td class="style3">
                    <div style="overflow: scroll; width: 780px; height: 450px" class="grdDiv">
                        <asp:GridView ID="gvSearch" runat="server" AllowPaging="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="HomeContactNo" HeaderText="Home Contact No"
