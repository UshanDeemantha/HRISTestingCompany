<%@ Page Title="HR | Fluency Types" Language="C#" MasterPageFile="~/Common/Common_MenuMasterPage.master" AutoEventWireup="true" CodeFile="FluencyType.aspx.cs" Inherits="Fluency_FluencyType" StylesheetTheme="Common" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:Label ID="Label17" runat="server" Height="30" Text="Fluency Type" Font-Names="Tahoma" Font-Bold="true" Font-Underline="true" ForeColor="#336699" Font-Size="Small"></asp:Label>
                    </td>
                    <td></td>
                </tr>
            </table>
