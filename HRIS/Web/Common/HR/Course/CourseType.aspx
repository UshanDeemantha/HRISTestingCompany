<%@ Page Title="HRIS Common | Course Types" Language="C#" MasterPageFile="~/Common/Common_MenuMasterPage.master" AutoEventWireup="true" CodeFile="CourseType.aspx.cs" Inherits="Course_CourseType" StylesheetTheme="Common" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script>
        function downloadExcel() {
            $.ajax({
                type: "POST",
                url: "CourseType.aspx/downloadExcelFromGrid",
        ...
        <div class="form-container shadow" id="formContainer" runat="server" style="height: 54px;">
            <div class="row">
                <div class="col head-container">
                    <h4 class="header">Course Types</h4>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtCourseCode" CssClass="form-label" ForeColor="Red"
                                        ErrorMessage="Required Field!" ValidationGroup="a">*</asp:RequiredFieldValidator>
                                    <telerik:RadTextBox ID="txtCourseCode" runat="server" MaxLength="50" Width="150px" CssClass="form-control form-control-lg"
                                        Skin="Windows7" />
                                </div>
                                </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
                                        ControlToValidate="txtCourseName" CssClass="form-label" ForeColor="Red"
                                        ErrorMessage="Required Field!" ValidationGroup="a">*</asp:RequiredFieldValidator>
        ...
        <div class="row" style="position: relative">
            ...
            <div class="col table-scroll">
                <dx:ASPxGridView ID="gvDetail" ClientInstanceName="grid" runat="server" ForeColor="Black" order-BorderColor="Black" Theme="MetropolisBlue" Width="100%"
                    KeyFieldName="EmployeeId" AutoGenerateColumns="False" ClientIDMode="AutoID" CssClass="tableStyle" DataSourceID="objdsCourseTypes">
                    <SettingsSearchPanel Visible="true" HighlightResults="true" />
                    <Columns>
                        <dx:GridViewDataColumn FieldName="CourseTypeID" Caption="CourseTypeID" PropertiesEditType="TextBox" Width="100px" CellStyle-HorizontalAlign="Center" Visible="false" />
                        <dx:GridViewDataColumn FieldName="CourseTypeCode" HeaderStyle-Font-Bold="false" Caption="Code" PropertiesEditType="TextBox" Width="100px" VisibleIndex="1" CellStyle-HorizontalAlign="Left" HeaderStyle-CssClass="headerStyle" CellStyle-CssClass="cellStyle" />
                        <dx:GridViewDataColumn FieldName="CourseTypeName" HeaderStyle-Font-Bold="false" Caption="Name" PropertiesEditType="TextBox" Width="800px" VisibleIndex="2" CellStyle-HorizontalAlign="Left" HeaderStyle-CssClass="headerStyle" CellStyle-CssClass="cellStyle" />
                        <dx:GridViewDataTextColumn Caption="" VisibleIndex="0" Width="30px" HeaderStyle-Font-Bold="false" CellStyle-HorizontalAlign="Center" HeaderStyle-CssClass="headerStyle" CellStyle-CssClass="cellStyle">
                            <DataItemTemplate>
                ...
                <dx:ASPxGridViewExporter ID="GridExporter" runat="server" GridViewID="gvDetail" FileName="Course Types">
                    <Styles>
