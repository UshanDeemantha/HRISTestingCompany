...
<%@ Register Src="EmployeeSearchNew.ascx" TagName="EmployeeSearch" TagPrefix="uc1" %>
                        ...
                        <div class="details">
                            ...
                            <div class="data-container">
                                <ul>
                                    ...
                                    <li>
                                        <asp:LinkButton ID="lbtnModify" runat="server" PostBackUrl='<%# "~/HR/Employee/ModifiyEmployeeAditionalInfo.aspx?EmployeeId="+Eval("EmployeeID") %>'
